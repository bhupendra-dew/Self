...
# checks weather the number are consecutive
def check(xyz):
    i = 1
    while i < len(xyz):
        if (xyz[i] - xyz[i - 1]) != 1:
        ...
        if cahnce == 'F':
            while True:
                if last == 20:
                    ...
                    # storing the last elemnt of xyz
                    last = xyz[-1]

                    # check weather th input number are consecutive 
                    if check(xyz) == True:
                        if last == 21:
                            lose1()
                        ...
                        print("\nYou did ot input consecutive integers.")
                        lose1()
            ...
            while last < 20:
                ...
                if xyz[-1] == 20:
                    ...
                    if check(xyz) == True:
                        ...
                        # if inputs are not consecutive automatically disqualified
